package com.ebc.randomsp.view.components.randomsp
...
@Composable
fun StartGuestScreen(navController: NavController,
                     randomSPViewModel: RandomSPViewModel) {

Text(text = "StartGuestScreen")}
